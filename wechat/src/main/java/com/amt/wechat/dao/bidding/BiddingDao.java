...
public interface BiddingDao {
    ...
    @Update("UPDATE bidding_recharge SET payStatus=#{payStatus},transactionId=#{transactionId},balance=#{balance},timeEnd=#{timeEnd},summary=#{summary} WHERE id = #{id}")
    public void updateRechargeRd(BiddingRechargeRd biddingRechargeRd);
