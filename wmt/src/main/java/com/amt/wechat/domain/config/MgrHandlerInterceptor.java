 ...
 * @version 1.0
 */
@Component("mgrHandlerInterceptor")
public class MgrHandlerInterceptor implements HandlerInterceptor {
    private static final Logger traceLog = LoggerFactory.getLogger("mgrTraceLog");
    private static final Logger logger = LoggerFactory.getLogger(MgrHandlerInterceptor.class);

    private  @Autowired RedisService redisService;

    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        String rnd1 = request.getParameter("rnd");
        Object rnd2 = request.getAttribute("rnd");
        logger.error("rnd1={},rnd2={}",rnd1,rnd2);
