package com.amt.wechat.domain.rabc.func;

import com.amt.wechat.domain.annotation.GetMappingEx;
import com.amt.wechat.domain.annotation.PostMappingEx;
...
public class FunctionCollector {
    ...
    private void extract(Class<?> cls,Method method,String funcName, FunctionModules module, String url) throws IllegalArgumentException{
        if(funcName == null || funcName.length()==0){
            throw new IllegalArgumentException("required argument:funcName!at:"+cls.getName()+"."+method.getName());
        }
        if(module == null || module == FunctionModules.NONE){
            throw new IllegalArgumentException("missed argument:module!at:"+cls.getName()+"."+method.getName());
        }
        if(module == FunctionModules.NONE){
